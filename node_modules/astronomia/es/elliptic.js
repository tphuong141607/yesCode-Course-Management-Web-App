...
export function position(planet, earth, jde) {
  ...
  var τ = base.lightTime(Δ); // repeating with jde-τ
  ...
  return new coord.Ecliptic(λ, β).toEquatorial(ε); // Meeus gives a formula for elongation but doesn't spell out how to
...
function () {
  ...
  */
  ...
  _proto.position = function position(jde, earth) {
    var _this = this;
    ...
    var f = function f(jde) {
      ...
      var r = kepler.radius(E, _this.ecc, _this.axis); // (33.9) p. 229
