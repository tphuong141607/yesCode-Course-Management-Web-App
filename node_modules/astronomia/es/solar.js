...
export function trueEquatorial(jde) {
  var _trueLongitude4 = trueLongitude(base.J2000Century(jde)),
  ...
  var _base$sincos2 = base.sincos(ε),
      sε = _base$sincos2[0],
      cε = _base$sincos2[1]; // (25.6, 25.7) p. 165
...
export function apparentEquatorial(jde) {
  ...
  var _base$sincos3 = base.sincos(λ),
      sλ = _base$sincos3[0],
      cλ = _base$sincos3[1]; // (25.8) p. 165


  var _base$sincos4 = base.sincos(ε + 0.00256 * Math.PI / 180 * Math.cos(node(T))),
      sε = _base$sincos4[0],
      cε = _base$sincos4[1];
...
export function trueVSOP87(planet, jde) {
  ...
  var _base$sincos5 = base.sincos(λp),
      sλp = _base$sincos5[0],
      cλp = _base$sincos5[1];
