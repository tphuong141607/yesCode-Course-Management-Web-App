...
function () {
  ...
  var _proto = Sunrise.prototype;

  _proto._calcNoon = function _calcNoon(jde) {
  ...
  _proto._calcRiseOrSet = function _calcRiseOrSet(jde, h0, isSet) {
    var etime = sexa.secFromHourAngle(eqtime.eSmart(jde));
  ...
  _proto._calcPolarDayNight = function _calcPolarDayNight(h0, isSet, step) {
    var jde = this.jde;
    var t;
    var failCnt = 0;
  ...
  _proto._calc = function _calc(h0, isSet) {
    var t;
  ...
  _proto.setStart = function setStart() {
  ...
  _proto.nauticalDawn = function nauticalDawn() {
  ...
  _proto.nauticalDusk = function nauticalDusk() {
  ...
  _proto.nightStart = function nightStart() {
  ...
  _proto.nightEnd = function nightEnd() {
  ...
  _proto.goldenHourStart = function goldenHourStart() {
  ...
  _proto.goldenHourEnd = function goldenHourEnd() {
