...
function () {
  ...
  var _proto = Ecliptic.prototype;

  _proto.toEquatorial = function toEquatorial(ε) {
...
function () {
  ...
  var _proto2 = Equatorial.prototype;

  _proto2.toEcliptic = function toEcliptic(ε) {
  ...
  _proto2.toHorizontal = function toHorizontal(g, st) {
  ...
  _proto2.toGalactic = function toGalactic() {
...
function () {
  ...
  var _proto3 = Horizontal.prototype;

  _proto3.toEquatorial = function toEquatorial(g, st) {
...
function () {
  ...
  var _proto4 = Galactic.prototype;

  _proto4.toEquatorial = function toEquatorial() {
