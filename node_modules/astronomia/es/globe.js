...
function () {
  ...
  var _proto = Ellipsoid.prototype;
  ...
  _proto.eccentricity = function eccentricity() {
  ...
  _proto.parallaxConstants = function parallaxConstants(φ, h) {
    var boa = 1 - this.flat;
  ...
  _proto.radiusAtLatitude = function radiusAtLatitude(φ) {
    var s = Math.sin(φ);
    var c = Math.cos(φ);
  ...
  _proto.radiusOfCurvature = function radiusOfCurvature(φ) {
    var s = Math.sin(φ);
  ...
  _proto.distance = function distance(c1, c2) {
    // From AA, ch 11, p 84.
    var _sincos = sincos2((c1.lat + c2.lat) / 2),
        s2f = _sincos[0],
        c2f = _sincos[1];

    var _sincos2 = sincos2((c1.lat - c2.lat) / 2),
        s2g = _sincos2[0],
        c2g = _sincos2[1];

    var _sincos3 = sincos2((c1.lon - c2.lon) / 2),
        s2λ = _sincos3[0],
        c2λ = _sincos3[1];
...
export var Earth76 = new Ellipsoid(6378.14, 1 / 298.257);
/**
...
export var RotationRate1996_5 = 7.292114992e-5; // eslint-disable-line camelcase
